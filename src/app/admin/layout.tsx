...
export default function DashboardLayout({
   ...
   const surat = [
      { name: 'Surat Izin Membangun Sementara', to: '/admin/imbS' },
      { name: 'Surat Pengantar dari Kantor Desa', to: '/admin/spDariDesa' },
      { name: 'Surat Pengantar ke Kantor Desa', to: '/admin/spkedesa' },
      { name: 'Surat Keterangan Aktif Perusahaan', to: '/admin/suketaktifperusahaan' },
      { name: 'Surat Keterangan Belum Memiliki Rumah', to: '/admin/suketbelumpunyarumah' },
      { name: 'Surat Keterangan Belum Terbit E-KTP', to: '/admin/suketblmktp' },
      { name: 'Surat Keterangan Domisili', to: '/admin/suketdomisili' },
      { name: 'Surat Keterangan Ghoib', to: '/admin/suketghoib' },
      { name: 'Surat Keterangan Jabatan', to: '/admin/suketjabatan' },
      { name: 'Surat Keterangan Kehilangan Kartu Keluarga', to: '/admin/suketkehilangankk' },
      { name: 'Surat Keterangan Kehilangan STPD', to: '/admin/suketkehilanganstpd' },
      { name: 'Surat Keterangan Kekerabatan Anak Kandung', to: '/admin/suketkekerabatan' },
      { name: 'Surat Keterangan Lahir Desa', to: '/admin/suketlahirdesa' },
      { name: 'Surat Keterangan Lokasi Tanah', to: '/admin/suketlokasitanah' },
      { name: 'Surat Keterangan Menantu', to: '/admin/suketmenantu' },
      { name: 'Surat Keterangan Penduduk Liar', to: '/admin/suketpendudukliar' },
      { name: 'Surat Keterangan Penegasan Wilayah', to: '/admin/suketpenegasanwil' },
      { name: 'Surat Keterangan Pengurusan PBB', to: '/admin/suketpengurusanpbb' },
      { name: 'Surat Keterangan Pernyataan Waris', to: '/admin/suketpernyataanwaris' },
      { name: 'Surat Keterangan Pisah Rumah', to: '/admin/suketpisahrumah' },
      { name: 'Surat Keterangan Taksiran Tanah', to: '/admin/sukettaksirantanah' },
      { name: 'Surat Keterangan Tanah', to: '/admin/sukettanah' },
      { name: 'Surat Keterangan Tanah Belum Pernah Diperjualbelikan', to: '/admin/sukettbpd' },
