...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 87720)), "/Users/andialifikhlasulamal/Documents/project/sipakamaseta/src/app/administrasi/form/suketdomisili/page.tsx"],
    ...
    const pages = ["/Users/andialifikhlasulamal/Documents/project/sipakamaseta/src/app/administrasi/form/suketdomisili/page.tsx"];
    
    const originalPathname = "/administrasi/form/suketdomisili/page"
    const __next_app__ = {
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 67388))
...
;// CONCATENATED MODULE: ./src/app/administrasi/form/suketdomisili/inputItem.tsx
...
;// CONCATENATED MODULE: ./src/app/administrasi/form/suketdomisili/page.tsx
/* __next_internal_client_entry_do_not_use__ default auto */ 
...
function Page() {
    ...
    async function submitData(event) {
        ...
        const data = {
            ...
            stsnkh: formData.get("stsnkh"),
            alamat: formData.get("alamat")
        };
        const resp = await (0,api/* postAPI */.l)("suketdomisili/buat", data);
        if (resp.status) {
            setNama(data.name);
            setShowModal(true);
        }
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/andialifikhlasulamal/Documents/project/sipakamaseta/src/app/administrasi/form/suketdomisili/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [1697,9308,4261,7215,248,5787,1629,8932,35,7891], () => (__webpack_exec__(31260)));
